...
`uvm_component_utils(alu_env)
 ...
 if(!uvm_config_db#(alu_config)::get(this,"","alu_config",m_cfg))
  ...
  inp_agt_h=alu_agent::type_id::create("inp_agt_h",this);
 ...
 function void connect_phase(uvm_phase phase);
        ...
        inp_agt_h.monh.inp_monitor_port.connect(sb_h.inp_mon_fifo.analysis_export);
        out_agt_h.monh.item_collected_port.connect(sb_h.out_mon_fifo.analysis_export);
 endfunction
